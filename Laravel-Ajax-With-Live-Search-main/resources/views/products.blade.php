    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2">     </div>
                <div class="col-md-8">
                    <h2 class="my-5 text-center">Laravel 9 Ajax Crud With Live Search</h2>
<a href="" class="btn btn-success my-3"  data-bs-toggle="modal" data-bs-target="#addModal">Add Product</a>
<input type="text" onkeyup="search()" name="search" id="search" class="mb-3 form-control" placeholder="Search Here..">
